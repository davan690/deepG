...
#' @param dataset [\code{data.frame}]\cr a dataframe holding training samples. If set, no generator will be used. Instead the dataset will hold in RAM during training.
#' @param validation.split only relevant when using dataset as input method. Defines the fraction of the batches that will be used for validation
...
#' @param batch.size how many chunks are trained in parallel, depends on GPU memory
